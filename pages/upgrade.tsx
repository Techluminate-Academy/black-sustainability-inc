...
export default function UpgradePage() {
  ...
  // Mock upgrade form for static export
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100">
      <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-md text-center">
        <div className="flex justify-center mb-6">
        ...
        <p className="text-gray-600 mb-6">
          Upgrade functionality is currently in demo mode for static export.
        </p>
        <div className="space-y-3">
          <button
            onClick={() => alert('Upgrade functionality disabled for static export')}
            className="w-full bg-blue-600 text-white py-3 px-4 rounded-lg hover:bg-blue-700"
          >
            Upgrade to Premium
          </button>
          <a
            href="/dashboard"
            className="w-full bg-gray-100 text-gray-700 py-3 px-4 rounded-lg hover:bg-gray-200 inline-block"
          >
            Back to Dashboard
          </a>
        </div>

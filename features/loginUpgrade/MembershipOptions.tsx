    ...
    <div className="w-full py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto mb-8">
          Select the membership tier that best fits your needs. Each tier offers unique benefits to help you maximize your impact in the sustainability community.
        </p>
      </div>
      ...
      <div className="inline-flex justify-center w-full gap-8">
        ...
        <div className="w-[350px] rounded-lg overflow-hidden flex flex-col shadow-lg border border-gray-200" style={{marginRight: 10}}>
          <div className="bg-yellow-400 p-6 text-center">
            ...
            <div className="text-gray-800 mt-2">Every month</div>
            <div className="text-gray-700 text-sm">Or $105/Year</div>
            <Link
        ...
        <div className="w-[350px] rounded-lg overflow-hidden flex flex-col shadow-lg border border-gray-200" style={{marginRight: 10}}>
          <div className="bg-yellow-400 p-6 text-center">
            ...
            <div className="text-gray-800 mt-2">Every month</div>
            <div className="text-gray-700 text-sm">Or $325/Year</div>
            <Link
        ...
        <div className="w-[350px] rounded-lg overflow-hidden flex flex-col shadow-lg relative border-2 border-yellow-500">
          ...
          <div className="bg-black p-6 text-center">
            ...
            <div className="text-white mt-2">Every month</div>
            <div className="text-white text-sm">Or $655/Year</div>
            <Link
